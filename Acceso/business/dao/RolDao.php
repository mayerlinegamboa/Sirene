<?php
  ...
  * permanently store and retrieve Rol object instances. 
  */
...
class RolDao {
     ...
     */
    function getObject($conn, $secrol) {

          $valueObject = $this->createValueObject();
          $valueObject->setSecrol($secrol);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSecrol()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tblrol WHERE (secrol = ".$valueObject->getSecrol().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tblrol ORDER BY secrol ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tblrol ( secrol, descripcion) VALUES (".$valueObject->getSecrol().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tblrol SET descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (secrol = ".$valueObject->getSecrol().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tblrol WHERE (secrol = ".$valueObject->getSecrol().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tblrol WHERE 1=1 ";
