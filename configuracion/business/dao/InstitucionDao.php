<?php
 ...
 /**
  * Institucion Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Institucion object instances. 
  */
...
class InstitucionDao {
     ...
     */
    function getObject($conn, $secinstitucion) {

          $valueObject = $this->createValueObject();
          $valueObject->setSecinstitucion($secinstitucion);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSecinstitucion()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tblinstitucion WHERE (secinstitucion = ".$valueObject->getSecinstitucion().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tblinstitucion ORDER BY secinstitucion ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tblinstitucion ( secinstitucion, nombre, nit, ";
          $sql = $sql."direccion, telefono, email) VALUES (".$valueObject->getSecinstitucion().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tblinstitucion SET nombre = '".$valueObject->getNombre()."', ";
          ...
          $sql = $sql." WHERE (secinstitucion = ".$valueObject->getSecinstitucion().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tblinstitucion WHERE (secinstitucion = ".$valueObject->getSecinstitucion().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function deleteAll($conn) {
          ...
          $sql = "DELETE FROM tblinstitucion";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function countAll($conn) {
          ...
          $sql = "SELECT count(*) FROM tblinstitucion";
          $allRows = 0;
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tblinstitucion WHERE 1=1 ";

          if ($valueObject->getSecinstitucion() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND secinstitucion = ".$valueObject->getSecinstitucion()." ";
          }
          ...
          $sql = $sql."ORDER BY secinstitucion ASC ";
    ...
    function singleQuery($conn, $sql, $valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setSecinstitucion($row[0]); 
                   $valueObject->setNombre($row[1]); 
                   $valueObject->setNit($row[2]); 
    ...
    function listQuery($conn, $sql) {
          ...
          while ($row = $conn->nextRow($result)) {
               ...
               $temp->setSecinstitucion($row[0]); 
               $temp->setNombre($row[1]); 
               $temp->setNit($row[2]); 
               $temp->setDireccion($row[3]); 
               $temp->setTelefono($row[4]); 
               $temp->setEmail($row[5]); 
