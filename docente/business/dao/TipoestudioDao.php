<?php
 ...
 /**
  * Tipoestudio Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Tipoestudio object instances. 
  */
...
class TipoestudioDao {
     ...
     */
    function getObject($conn, $sectipoestudio) {

          $valueObject = $this->createValueObject();
          $valueObject->setSectipoestudio($sectipoestudio);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSectipoestudio()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tbltipoestudio WHERE (sectipoestudio = ".$valueObject->getSectipoestudio().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tbltipoestudio ORDER BY sectipoestudio ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tbltipoestudio ( sectipoestudio, descripcion) VALUES (".$valueObject->getSectipoestudio().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tbltipoestudio SET descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (sectipoestudio = ".$valueObject->getSectipoestudio().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tbltipoestudio WHERE (sectipoestudio = ".$valueObject->getSectipoestudio().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function deleteAll($conn) {
          ...
          $sql = "DELETE FROM tbltipoestudio";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function countAll($conn) {
          ...
          $sql = "SELECT count(*) FROM tbltipoestudio";
          $allRows = 0;
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tbltipoestudio WHERE 1=1 ";
          ...
          $sql = $sql."ORDER BY sectipoestudio ASC ";
    ...
    function singleQuery($conn, $sql, $valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setSectipoestudio($row[0]); 
