<?php
 ...
 /**
  * Cargo Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Cargo object instances. 
  */
...
class CargoDao {
     ...
     */
    function getObject($conn, $seccargo) {

          $valueObject = $this->createValueObject();
          $valueObject->setSeccargo($seccargo);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSeccargo()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tblcargo WHERE (seccargo = ".$valueObject->getSeccargo().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tblcargo ORDER BY seccargo ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tblcargo ( seccargo, descripcion) VALUES (".$valueObject->getSeccargo().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tblcargo SET descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (seccargo = ".$valueObject->getSeccargo().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tblcargo WHERE (seccargo = ".$valueObject->getSeccargo().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function countAll($conn) {
          ...
          $sql = "SELECT count(*) FROM tblcargo";
          $allRows = 0;
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tblcargo WHERE 1=1 ";
