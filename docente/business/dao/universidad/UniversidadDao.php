<?php
 ...
 /**
  * Universidad Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Universidad object instances. 
  */
...
class UniversidadDao {
     ...
     */
    function getObject($conn, $secuniversidad) {

          $valueObject = $this->createValueObject();
          $valueObject->setSecuniversidad($secuniversidad);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSecuniversidad()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tbluniversidad WHERE (secuniversidad = ".$valueObject->getSecuniversidad().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tbluniversidad ORDER BY secuniversidad ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tbluniversidad ( secuniversidad, descripcion, telefono, ";
          $sql = $sql."movil, direccion, nit, ";
          $sql = $sql."sitioweb, secciudad) VALUES (".$valueObject->getSecuniversidad().", ";
          ...
          $sql = $sql."'".$valueObject->getNit()."', ";
          $sql = $sql."'".$valueObject->getSitioweb()."', ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tbluniversidad SET descripcion = '".$valueObject->getDescripcion()."', ";
          $sql = $sql."telefono = '".$valueObject->getTelefono()."', ";
          $sql = $sql."movil = '".$valueObject->getMovil()."', ";
          $sql = $sql."direccion = '".$valueObject->getDireccion()."', ";
          $sql = $sql."nit = '".$valueObject->getNit()."', ";
          $sql = $sql."sitioweb = '".$valueObject->getSitioweb()."', ";
          $sql = $sql."secciudad = ".$valueObject->getSecciudad()."";
          $sql = $sql." WHERE (secuniversidad = ".$valueObject->getSecuniversidad().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tbluniversidad WHERE (secuniversidad = ".$valueObject->getSecuniversidad().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function deleteAll($conn) {
          ...
          $sql = "DELETE FROM tbluniversidad";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function countAll($conn) {
          ...
          $sql = "SELECT count(*) FROM tbluniversidad";
          $allRows = 0;
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tbluniversidad WHERE 1=1 ";

          if ($valueObject->getSecuniversidad() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND secuniversidad = ".$valueObject->getSecuniversidad()." ";
          }
          ...
          if ($valueObject->getNit() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND nit LIKE '".$valueObject->getNit()."%' ";
          }

          if ($valueObject->getSitioweb() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND sitioweb LIKE '".$valueObject->getSitioweb()."%' ";
          }
          ...
          $sql = $sql."ORDER BY secuniversidad ASC ";
    ...
    function singleQuery($conn, $sql, $valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setSecuniversidad($row[0]); 
                   $valueObject->setDescripcion($row[1]); 
                   $valueObject->setTelefono($row[2]); 
                   $valueObject->setMovil($row[3]); 
                   $valueObject->setDireccion($row[4]); 
                   $valueObject->setNit($row[5]); 
                   $valueObject->setSitioweb($row[6]); 
                   $valueObject->setSecciudad($row[7]); 
          } else {
    ...
    function listQuery($conn, $sql) {
          ...
          while ($row = $conn->nextRow($result)) {
               ...
               $temp->setSecuniversidad($row[0]); 
               $temp->setDescripcion($row[1]); 
               $temp->setTelefono($row[2]); 
               $temp->setMovil($row[3]); 
               $temp->setDireccion($row[4]); 
               $temp->setNit($row[5]); 
               $temp->setSitioweb($row[6]); 
               $temp->setSecciudad($row[7]); 
