...
class CursoDao {
     ...
     */
    function getObject($conn, $seccurso) {

          $valueObject = $this->createValueObject();
          $valueObject->setSeccurso($seccurso);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSeccurso()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tblcurso WHERE (seccurso = ".$valueObject->getSeccurso().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tblcurso ORDER BY seccurso ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tblcurso ( seccurso, descripcion) VALUES (".$valueObject->getSeccurso().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tblcurso SET descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (seccurso = ".$valueObject->getSeccurso().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tblcurso WHERE (seccurso = ".$valueObject->getSeccurso().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function countAll($conn) {
          ...
          $sql = "SELECT count(*) FROM tblcurso";
          $allRows = 0;
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tblcurso WHERE 1=1 ";

          if ($valueObject->getSeccurso() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND seccurso = ".$valueObject->getSeccurso()." ";
          }
