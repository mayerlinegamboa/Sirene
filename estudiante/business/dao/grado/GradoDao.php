<?php
 ...
 /**
  * Grado Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Grado object instances. 
  */
...
class GradoDao {
     ...
     */
    function getObject($conn, $secgrado) {

          $valueObject = $this->createValueObject();
          $valueObject->setSecgrado($secgrado);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSecgrado()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tblgrado WHERE (secgrado = ".$valueObject->getSecgrado().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tblgrado ORDER BY secgrado ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tblgrado ( secgrado, descripcion) VALUES (".$valueObject->getSecgrado().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tblgrado SET descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (secgrado = ".$valueObject->getSecgrado().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tblgrado WHERE (secgrado = ".$valueObject->getSecgrado().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function countAll($conn) {
          ...
          $sql = "SELECT count(*) FROM tblgrado";
          $allRows = 0;
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tblgrado WHERE 1=1 ";

          if ($valueObject->getSecgrado() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND secgrado = ".$valueObject->getSecgrado()." ";
          }
