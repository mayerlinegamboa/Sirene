...
<html>
    ...
    <body>
        ...
        <div id="pnlPrincipal" class="completo_div" > 


            <div class="centrado">                
                <div class="foldtl">
                    <div id="hojadoblada" style="width: 100%">
                        <img src="resources/images/03799331630580127.png" width="80%" height="20%" 
                             style="margin-left: 8%" alt="SIRENE" />
                        <br />
                        <div id="pnliniciarsesion"  >
                            <div class="centraTabla" >

                                <table style="text-align: center" >
                                    <thead>Iniciar Sesión</thead>
                                    <tbody>
                                        <tr>
                                            <td style="text-align: right">Login: *</td>
                                            <td><input id="txtlogin" type="text" title="Ingrese Login" /></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <button id="btniniciar" type="button" title="Iniciar Sesi&oacute;n">Iniciar</button> 
                                            </td>
                                        </tr>
                                    </tbody>                                
                                </table>
            ...
            <div id="pnlcreditos" title="Desarrollado por Mayerline Gamboa - Nelsy Eliana Sanchez" class="divabajo">      
