<?php
 ...
 /**
  * Materia Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Materia object instances. 
  */
...
class MateriaDao {
     ...
     */
    function getObject($conn, $secmateria) {

          $valueObject = $this->createValueObject();
          $valueObject->setSecmateria($secmateria);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSecmateria()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tblmateria WHERE (secmateria = ".$valueObject->getSecmateria().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tblmateria ORDER BY secmateria ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tblmateria ( secmateria, descripcion) VALUES (".$valueObject->getSecmateria().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tblmateria SET descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (secmateria = ".$valueObject->getSecmateria().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tblmateria WHERE (secmateria = ".$valueObject->getSecmateria().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function countAll($conn) {
          ...
          $sql = "SELECT count(*) FROM tblmateria";
          $allRows = 0;
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tblmateria WHERE 1=1 ";

          if ($valueObject->getSecmateria() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND secmateria = ".$valueObject->getSecmateria()." ";
          }
          ...
          $sql = $sql."ORDER BY secmateria ASC ";
    ...
    function singleQuery($conn, $sql, $valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setSecmateria($row[0]); 
