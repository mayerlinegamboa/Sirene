...
class SexoDao {
     ...
     */
    function getObject($conn, $secsexo) {

          $valueObject = $this->createValueObject();
          $valueObject->setSecsexo($secsexo);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSecsexo()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tblsexo WHERE (secsexo = ".$valueObject->getSecsexo().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tblsexo ORDER BY secsexo ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tblsexo ( secsexo, descripcion) VALUES (".$valueObject->getSecsexo().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tblsexo SET descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (secsexo = ".$valueObject->getSecsexo().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tblsexo WHERE (secsexo = ".$valueObject->getSecsexo().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tblsexo WHERE 1=1 ";

          if ($valueObject->getSecsexo() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND secsexo = ".$valueObject->getSecsexo()." ";
          }
