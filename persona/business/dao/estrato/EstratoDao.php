<?php
 ...
 /**
  * Estrato Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Estrato object instances. 
  */
...
class EstratoDao {
     ...
     */
    function getObject($conn, $secestrato) {

          $valueObject = $this->createValueObject();
          $valueObject->setSecestrato($secestrato);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSecestrato()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tblestrato WHERE (secestrato = ".$valueObject->getSecestrato().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tblestrato ORDER BY secestrato ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tblestrato ( secestrato, descripcion) VALUES (".$valueObject->getSecestrato().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tblestrato SET descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (secestrato = ".$valueObject->getSecestrato().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tblestrato WHERE (secestrato = ".$valueObject->getSecestrato().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function countAll($conn) {
          ...
          $sql = "SELECT count(*) FROM tblestrato";
          $allRows = 0;
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tblestrato WHERE 1=1 ";
          ...
          $sql = $sql."ORDER BY secestrato ASC ";
    ...
    function singleQuery($conn, $sql, $valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setSecestrato($row[0]); 
