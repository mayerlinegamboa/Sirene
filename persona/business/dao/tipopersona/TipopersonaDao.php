<?php
 ...
 /**
  * Tipopersona Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Tipopersona object instances. 
  */
...
class TipopersonaDao {
     ...
     */
    function getObject($conn, $sectipopersona) {

          $valueObject = $this->createValueObject();
          $valueObject->setSectipopersona($sectipopersona);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSectipopersona()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tbltipopersona WHERE (sectipopersona = ".$valueObject->getSectipopersona().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tbltipopersona ORDER BY sectipopersona ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tbltipopersona ( sectipopersona, descripcion) VALUES (".$valueObject->getSectipopersona().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tbltipopersona SET descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (sectipopersona = ".$valueObject->getSectipopersona().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tbltipopersona WHERE (sectipopersona = ".$valueObject->getSectipopersona().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function deleteAll($conn) {
          ...
          $sql = "DELETE FROM tbltipopersona";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function countAll($conn) {
          ...
          $sql = "SELECT count(*) FROM tbltipopersona";
          $allRows = 0;
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tbltipopersona WHERE 1=1 ";
          ...
          $sql = $sql."ORDER BY sectipopersona ASC ";
    ...
    function singleQuery($conn, $sql, $valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setSectipopersona($row[0]); 
