<?php
 ...
 /**
  * Tiposangre Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Tiposangre object instances. 
  */
...
class TiposangreDao {
     ...
     */
    function getObject($conn, $sectipodesangre) {

          $valueObject = $this->createValueObject();
          $valueObject->setSectipodesangre($sectipodesangre);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSectipodesangre()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tbltipodesangre WHERE (sectipodesangre = ".$valueObject->getSectipodesangre().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tbltipodesangre ORDER BY sectipodesangre ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tbltipodesangre ( sectipodesangre, descripcion) VALUES (".$valueObject->getSectipodesangre().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tbltipodesangre SET descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (sectipodesangre = ".$valueObject->getSectipodesangre().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tbltipodesangre WHERE (sectipodesangre = ".$valueObject->getSectipodesangre().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function deleteAll($conn) {
          ...
          $sql = "DELETE FROM tbltipodesangre";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function countAll($conn) {
          ...
          $sql = "SELECT count(*) FROM tbltipodesangre";
          $allRows = 0;
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tbltipodesangre WHERE 1=1 ";

          if ($valueObject->getSectipodesangre() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND sectipodesangre = ".$valueObject->getSectipodesangre()." ";
          }
          ...
          $sql = $sql."ORDER BY sectipodesangre ASC ";
    ...
    function singleQuery($conn, $sql, $valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setSectipodesangre($row[0]); 
