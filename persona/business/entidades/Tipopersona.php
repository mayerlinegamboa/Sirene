<?php
 ...
 /**
  * Tipopersona Value Object.
  * This class is value object representing database table tbltipopersona
...
class Tipopersona {
    ...
    /* function Tipopersona ($sectipopersonaIn) {
    ...
    function setAll($sectipopersonaIn,
          $descripcionIn) {
          $this->sectipopersona = $sectipopersonaIn;
          $this->descripcion = $descripcionIn;
    }
    ...
    /** 
     * hasEqualMapping-method will compare two Tipopersona instances
    ...
    function toString() {
        ...
        $out = $out."\nclass Tipopersona, mapping to table tbltipopersona\n";
