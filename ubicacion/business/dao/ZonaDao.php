<?php
 ...
 /**
  * Zona Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Zona object instances. 
  */
...
class ZonaDao {
     ...
     */
    function getObject($conn, $seczona) {

          $valueObject = $this->createValueObject();
          $valueObject->setSeczona($seczona);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getSeczona()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM tblzona WHERE (seczona = ".$valueObject->getSeczona().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM tblzona ORDER BY seczona ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO tblzona ( seczona, descripcion) VALUES (".$valueObject->getSeczona().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE tblzona SET descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (seczona = ".$valueObject->getSeczona().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM tblzona WHERE (seczona = ".$valueObject->getSeczona().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM tblzona WHERE 1=1 ";
